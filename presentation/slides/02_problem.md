...
## Greenhouse decisions are genuinely hard to make locally

People who want to grow in protected structures in Nova Scotia face a specific and solvable problem: **decision friction**.
...
|--------|-----------------|----------------|
| Manufacturer websites | Specs and sizes | Local fit, climate, readiness |
| Garden centres | General advice | Structured decision support |
| Online forums | Anecdotes | Consistency, local grounding |
| Consultants | Expertise | Accessibility, cost |

---

> *The problem is not lack of information. The problem is lack of structured, locally-grounded decision support.*
