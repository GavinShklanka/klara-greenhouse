...
### Revenue logic (current thinking)
...
- **Not a marketplace:** Klara does not list, compare, or transact greenhouse products at scale
- **Not a subscription tool:** No recurring monitoring or ongoing service in current scope
- **Not a platform play:** No third-party developer ecosystem, no API commerce layer

---

### Why the model is narrow right now

The model expands as validation proves that the routing is credible. A referral to a supplier only has value if the recommendation was trusted. That's why validation comes first.

---

> *The business case depends on the recommendation being right. That's exactly what we're validating.*
